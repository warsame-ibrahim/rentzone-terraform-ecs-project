...
resource "aws_nat_gateway" "nat_gateway_az1" {
  ...
  tags   = {
    Name = "${var.Project_name}-${var.enviroment}-Nat-AZ1"
  }
...
resource "aws_nat_gateway" "nat_gateway_az2" {
  ...
  tags   = {
    Name = "${var.Project_name}-${var.enviroment}-Nat-AZ2"
  }
...
resource "aws_route_table" "private_route_table_az1" {
  ...
  tags   = {
    Name = "${var.Project_name}-${var.enviroment}-Private-rtb-az1"
  }
}
...
resource "aws_route_table" "private_route_table_az2" {
  ...
  tags   = {
    Name = "${var.Project_name}-${var.enviroment}-Private-rtb-az2"
  }
}
